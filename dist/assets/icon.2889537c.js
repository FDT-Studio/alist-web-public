import{r as h,s as o,t as e,v as p,w as c,m,x as n,y as f,z as d,A as F,C as v,D as E,E as M}from"./index.99b8af10.js";import{f as u,g as H,i as B,j as I}from"./index.d094cdfe.js";import{aj as i,c9 as V,ca as x}from"./index.54b8dc05.js";import{I as A}from"./Layout.5dc15e09.js";import{a as k}from"./index.48ee7514.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function z(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function U(a){return i({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":f,apk:A,db:u,md:d,epub:H,iso:B,m3u8:c,"doc,docx":F,"xls,xlsx":v,"ppt,pptx":E,pdf:M,psd:z,ai:D,url:I,cast:k},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return c;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},O=a=>Z(a.type,V(a.name));export{U as A,l as O,O as g};
